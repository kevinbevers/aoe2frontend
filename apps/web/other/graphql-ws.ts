...
// }
//
// export class GraphQLWebSocketClientCustom {
...
//
//     constructor(socket: WebSocket, { onInit, onAcknowledged, onPing, onPong, onClose }: SocketHandler) {
//         this.socket = socket
//
...
//         return new Promise<{ data: T; extensions?: E; headers?: any; status?: number }>(
//             (resolve, reject) => {
