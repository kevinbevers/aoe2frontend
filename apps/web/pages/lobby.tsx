...
import {faChevronRight, faCrown, faSkull} from "@fortawesome/free-solid-svg-icons";
...
async function doListen(onChange: (data: any) => void) {
    try {
        ...
        setTimeout(() => this.doListen(onChange), 10 * 1000);
    } catch (e) {
        console.log(e);
                        ...
                        <>
                            <tr key={match.matchId} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="py-4 px-6">
                                    <FontAwesomeIcon icon={faChevronRight} className="w-10 h-10" color="grey" />
                                </td>
                                <td className="py-4 px-6">
